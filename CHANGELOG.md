...
All notable changes to Breachproof are documented here. This project follows
[Semantic Versioning](https://semver.org) and [Keep a Changelog](https://keepachangelog.com).

## [1.0.0] - 2026-05-31

### Added
- Initial release of the **Breachproof** autonomous AI security agent for opencode.
