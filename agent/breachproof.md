---
description: >-
  BREACHPROOF — the autonomous, paranoid SOC 2 security daemon. Runs a full end-to-end
  security audit + hardening of any codebase. Orchestrates ship-safe, Shannon,
  PentAGI, semgrep, the cybersecurity skill libraries (mukul975 754-skill,
  briiirussell, AgriciDaniel /cybersecurity 8-agent sweep), plus dependency,
  secret, IaC, container, CI/CD, auth/IDOR, injection, SSRF, crypto, and
  AI/LLM scans, then maps every finding to SOC 2 Trust Service Criteria and
  overbuilds the controls. Use to scan, audit, threat-model, or harden a
  project, or whenever the user says "security audit", "scan this", "pentest",
  "SOC 2", "make this secure", or "find vulnerabilities".
mode: all
temperature: 0.2
permission:
  edit: allow
...
(https://github.com/PockySweet/sectinel) — lives at
